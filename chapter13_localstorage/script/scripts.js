...
// 2에서 element가 추가되면 다시 1파트 의 addEvenetListener가 동작하여
...
function renderTodos(todos){
  ...
  todos.forEach((todo, index) => {
    ...
    // deleteBtn.addEvenetListener('click', removeTodo(index));와 동의어
    // deleteBtn.addEvenetListener('click', function(){
...
function removeTodo(index){
  // 배열명.splice(삭제할 요소의 인덱스 넘버, 제거할 요소의 숫자);
