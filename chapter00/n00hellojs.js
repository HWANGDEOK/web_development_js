...
// 길게 작성했을 경우에도 동일하게 우리는 ctrl + / 를 이용하여
// 주석처리가 됩니다.
...
// console.log(a,b)  // 결과 값 : 안녕하세요 true :
...
//     at n00hellojs.js:31:2
// let c = 10;  -> 동일한 변수를 두 번 선언했기 때문
// let c = 12;
// Uncaught SyntaxError: Identifier 'c' has already been declared (at n00hellojs.js:35:5)
...
// // 이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되구요,
// // 비교 연산의 결과값을 산출할 때 많이 사용됩니다.
...
// null의 타입은 'object'로 반환 -> 초기 설계 부실 문제
...
// console.log(a==d, a != d);  // flase true
