...
// // 이상의 코드는 boolean 값을 변수에 대입하여 분기를 조절할 수 있습니다/ 11번 라인은 open 변수임에도 실행되지 않는다는 점에서 분기를 조절가능합니다.
...
switch(yoot){
  case "도": console.log("1칸 전진");break;
  case "개": console.log("2칸 전진");break;
  case "걸": console.log("3칸 전진");break;
  case "윷": console.log("4칸 전진");break;
  case "모": console.log("5칸 전진");break;
}
